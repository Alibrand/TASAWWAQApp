...
public class RecentlyListAdapter extends  RecyclerView.Adapter<RecentlyItem> {
    List<Stuff> stuffList;
    Context context;
    FirebaseStorage storage;
    FirebaseAuth firebaseAuth;

    public RecentlyListAdapter(List<Stuff> stuffList, Context context) {
    ...
    @NonNull
    @Override
    public RecentlyItem onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_recently,parent,false);
        return new RecentlyItem(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecentlyItem holder, int position) {
        ...
        holder.txt_main_category.setText(stuff.getMain_category());
...
class RecentlyItem extends RecyclerView.ViewHolder
{
TextView txt_name,txt_main_category;
ImageView image;
LinearLayoutCompat item_card;
    public RecentlyItem(@NonNull View itemView) {
        super(itemView);
        txt_name=itemView.findViewById(R.id.txt_name);
        image=itemView.findViewById(R.id.image);
        txt_main_category=itemView.findViewById(R.id.txt_main_category);
