...
public class StuffListAdapter extends RecyclerView.Adapter<StuffItem> {
    ...
    public StuffListAdapter(List<Stuff> stuffList, Context context) {
    ...
    @NonNull
    @Override
    public StuffItem onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_stuff,parent,false);
        return new StuffItem(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StuffItem holder, int position) {
            Stuff stuff=stuffList.get(position);

            holder.txt_description.setText(stuff.getTitle());
            holder.txt_price.setText((int)stuff.getPrice()+" S.R");
...
class StuffItem extends RecyclerView.ViewHolder
{
        ImageView stuff_image;
        TextView txt_price,txt_description;
        CardView stuff_card;
    public StuffItem(@NonNull View itemView) {
        super(itemView);
