...
import com.ksacp2022t3.tasawwaq.adapters.MyOrdersListAdapter;
...
public class MyOrdersActivity extends AppCompatActivity {
    ...
    private void load_orders(){
        ...
        firestore.collection("orders")
                .whereEqualTo("requester_uid",firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        MyOrdersListAdapter adapter=new MyOrdersListAdapter(orderList, MyOrdersActivity.this);
